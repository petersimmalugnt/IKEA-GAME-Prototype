...
export function Balloon({ materialColor0 = 3, materialHidden0 = false, ...props }: BalloonProps) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['Balloon_color3_singleTone'].name} geometry={nodes['Balloon_color3_singleTone'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
