...
import modelUrl from './balloon3.glb?url'

type MaterialColorSlot = 'materialColor0'
type MaterialHiddenSlot = 'materialHidden0'

type Balloon3Props = ThreeElements['group'] & {
  materialColor0?: MaterialColorIndex
  materialHidden0?: boolean
}

export function Balloon3({ materialColor0 = 3, materialHidden0 = false, ...props }: Balloon3Props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['BalloonGeo_color3_singleTone'].name} geometry={nodes['BalloonGeo_color3_singleTone'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
