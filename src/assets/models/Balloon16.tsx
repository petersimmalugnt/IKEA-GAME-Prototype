...
import modelUrl from './balloon16.glb?url'

type MaterialColorSlot = 'materialColor0'
type MaterialHiddenSlot = 'materialHidden0'

type Balloon16Props = ThreeElements['group'] & {
  materialColor0?: MaterialColorIndex
  materialHidden0?: boolean
}

export function Balloon16({ materialColor0 = 3, materialHidden0 = false, ...props }: Balloon16Props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['Balloon16_color3_singleTone'].name} geometry={nodes['Balloon16_color3_singleTone'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
