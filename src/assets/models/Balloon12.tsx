...
import modelUrl from './balloon12.glb?url'

type MaterialColorSlot = 'materialColor0'
type MaterialHiddenSlot = 'materialHidden0'

type Balloon12Props = ThreeElements['group'] & {
  materialColor0?: MaterialColorIndex
  materialHidden0?: boolean
}

export function Balloon12({ materialColor0 = 3, materialHidden0 = false, ...props }: Balloon12Props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['Balloon12_color3_singleTone'].name} geometry={nodes['Balloon12_color3_singleTone'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
