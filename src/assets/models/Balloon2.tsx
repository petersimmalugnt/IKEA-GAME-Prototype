...
import modelUrl from './balloon2.glb?url'

type MaterialColorSlot = 'materialColor0'
type MaterialHiddenSlot = 'materialHidden0'

type Balloon2Props = ThreeElements['group'] & {
  materialColor0?: MaterialColorIndex
  materialHidden0?: boolean
}

export function Balloon2({ materialColor0 = 3, materialHidden0 = false, ...props }: Balloon2Props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['BalloonGeo_color3_singleTone_1'].name} geometry={nodes['BalloonGeo_color3_singleTone_1'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
