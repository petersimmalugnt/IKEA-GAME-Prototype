...
import modelUrl from './balloon28.glb?url'

type MaterialColorSlot = 'materialColor0'
type MaterialHiddenSlot = 'materialHidden0'

type Balloon28Props = ThreeElements['group'] & {
  materialColor0?: MaterialColorIndex
  materialHidden0?: boolean
}

export function Balloon28({ materialColor0 = 3, materialHidden0 = false, ...props }: Balloon28Props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['Balloon28_color3_singleTone'].name} geometry={nodes['Balloon28_color3_singleTone'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
