...
Model: halfCylinder_realDimensions.glb
*/
...
import modelUrl from './halfCylinder_realDimensions.glb?url'
...
export type HalfCylinderRealDimensionsProps = ThreeElements['group'] & {
...
const PRIMARY_MESH_KEY = 'halfCynlinderLarge_dynamic_color1_collision'
...
function resolveMesh(nodes: Record<string, THREE.Mesh>): THREE.Mesh {
  ...
  throw new Error('HalfCylinder realDimensions mesh node not found in GLTF.')
}

export function HalfCylinder_realDimensions({
  materialColor0 = 1,
  ...
  rigidBodyOne,
  ...props
}: HalfCylinderRealDimensionsProps) {
