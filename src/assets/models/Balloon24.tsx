...
import modelUrl from './balloon24.glb?url'

type MaterialColorSlot = 'materialColor0'
type MaterialHiddenSlot = 'materialHidden0'

type Balloon24Props = ThreeElements['group'] & {
  materialColor0?: MaterialColorIndex
  materialHidden0?: boolean
}

export function Balloon24({ materialColor0 = 3, materialHidden0 = false, ...props }: Balloon24Props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group name={""}>
        <C4DMesh name={nodes['Balloon24_color3_singleTone'].name} geometry={nodes['Balloon24_color3_singleTone'].geometry} castShadow receiveShadow visible={!materialHiddens.materialHidden0}>
